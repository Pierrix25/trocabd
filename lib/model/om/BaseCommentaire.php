...
abstract class BaseCommentaire extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CommentairePeer::ID;
		}
	...
	public function setCommentaire($v)
	{
		...
		if ($this->commentaire !== $v) {
			$this->commentaire = $v;
			$this->modifiedColumns[] = CommentairePeer::COMMENTAIRE;
		}
	...
	public function setNote($v)
	{
		...
		if ($this->note !== $v) {
			$this->note = $v;
			$this->modifiedColumns[] = CommentairePeer::NOTE;
		}
	...
	public function setAlbumId($v)
	{
		...
		if ($this->album_id !== $v) {
			$this->album_id = $v;
			$this->modifiedColumns[] = CommentairePeer::ALBUM_ID;
		}
	...
	public function setUtilisateurId($v)
	{
		...
		if ($this->utilisateur_id !== $v) {
			...
			$this->modifiedColumns[] = CommentairePeer::UTILISATEUR_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = CommentairePeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = CommentairePeer::UPDATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Commentaire object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CommentairePeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(CommentairePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(CommentairePeer::UPDATED_AT))
    {
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aUtilisateur !== null) {
				...
				$this->setUtilisateur($this->aUtilisateur);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CommentairePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CommentairePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CommentairePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CommentairePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CommentairePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CommentairePeer::ID)) $criteria->add(CommentairePeer::ID, $this->id);
		if ($this->isColumnModified(CommentairePeer::COMMENTAIRE)) $criteria->add(CommentairePeer::COMMENTAIRE, $this->commentaire);
		if ($this->isColumnModified(CommentairePeer::NOTE)) $criteria->add(CommentairePeer::NOTE, $this->note);
		if ($this->isColumnModified(CommentairePeer::ALBUM_ID)) $criteria->add(CommentairePeer::ALBUM_ID, $this->album_id);
		if ($this->isColumnModified(CommentairePeer::UTILISATEUR_ID)) $criteria->add(CommentairePeer::UTILISATEUR_ID, $this->utilisateur_id);
		if ($this->isColumnModified(CommentairePeer::CREATED_AT)) $criteria->add(CommentairePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(CommentairePeer::UPDATED_AT)) $criteria->add(CommentairePeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CommentairePeer::ID, $this->id);
