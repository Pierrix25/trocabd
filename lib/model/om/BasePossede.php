...
abstract class BasePossede extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PossedePeer::ID;
		}
	...
	public function setUtilisateurId($v)
	{
		...
		if ($this->utilisateur_id !== $v) {
			...
			$this->modifiedColumns[] = PossedePeer::UTILISATEUR_ID;
		}
	...
	public function setAlbumId($v)
	{
		...
		if ($this->album_id !== $v) {
			$this->album_id = $v;
			$this->modifiedColumns[] = PossedePeer::ALBUM_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = PossedePeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = PossedePeer::UPDATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->album_id = $rs->getInt($startcol + 2);
			...
			throw new PropelException("Error populating Possede object", $e);
		}
	}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(PossedePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(PossedePeer::UPDATED_AT))
    {
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aAlbum !== null) {
				...
				$this->setAlbum($this->aAlbum);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PossedePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PossedePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PossedePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PossedePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PossedePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAlbumId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PossedePeer::ID)) $criteria->add(PossedePeer::ID, $this->id);
		if ($this->isColumnModified(PossedePeer::UTILISATEUR_ID)) $criteria->add(PossedePeer::UTILISATEUR_ID, $this->utilisateur_id);
		if ($this->isColumnModified(PossedePeer::ALBUM_ID)) $criteria->add(PossedePeer::ALBUM_ID, $this->album_id);
		if ($this->isColumnModified(PossedePeer::CREATED_AT)) $criteria->add(PossedePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(PossedePeer::UPDATED_AT)) $criteria->add(PossedePeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PossedePeer::ID, $this->id);
