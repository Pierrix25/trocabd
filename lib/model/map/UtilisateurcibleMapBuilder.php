...
class UtilisateurcibleMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.UtilisateurcibleMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('utilisateurcible');
		$tMap->setPhpName('Utilisateurcible');
