...
// $this->map->disableSidebar(); 
  ...
  public function executeUpdate()
  {
	    ...
	    $cScenariste = new Criteria();
	    $cScenariste->add(AuteurPeer::ID, '%'.$this->getRequestParameter('idNomScenariste'));
...
*/	    
	  	...
	  	$this->redirect('gereBD/show?id='.$bd->getId().'&sort='.$this->getRequestParameter('sort').'&rechercher='.$this->getRequestParameter('rechercher'));
  }
